    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!--begin::Form-->
                <form action="{{ route('admin_panel.partners.update', $partner->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 {{ $errors->has('image') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="file" name="image" id="image" class="form-control m-input">
                                    <div class="mt-2">
                                        <img src="{{ $partner->image != '' ? asset('uploads/partner_images/' . $partner->image) :  '' }}" id="image-preview" width="200px" height="200px" />
                                    </div>
                                @if ($errors->has('image'))
