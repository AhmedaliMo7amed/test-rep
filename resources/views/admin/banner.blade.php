...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            ...
            <!--begin::Form-->
            <form action="{{ route('admin_panel.update_banner') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 {{ $errors->has('title') ? ' has-error' : '' }} mb-50">
                            ...
                            <input type="text" name="title" class="form-control m-input" required="required"
                                value="{{ $banner->title != null ? $banner->title : old('title') }}" placeholder="Name">
                        ...
                        <div class="col-lg-6 {{ $errors->has('description') ? ' has-error' : '' }} mb-50">
                            ...
                            <textarea rows="5" name="description" id="english_editor" class="form-control" required="required" placeholder="Description">{{ $banner->description != null ? $banner->description : old('description') }}</textarea>
                        ...
                        <div class="col-lg-6 {{ $errors->has('button') ? ' has-error' : '' }} mb-50">
                            ...
                            <input type="text" name="button" class="form-control m-input" required="required"
                                value="{{ $banner->button != null ? $banner->button : old('button') }}" placeholder="Button">
                        ...
                        <div class="col-lg-6 {{ $errors->has('button_link') ? ' has-error' : '' }} mb-50">
                            ...
                            <input type="text" name="button_link" class="form-control m-input"
                                value="{{ $banner->button_link != null ? $banner->button_link : old('button_link') }}" placeholder="Button Link">
                        ...
                        <div class="col-lg-6 {{ $errors->has('image') ? ' has-error' : '' }} mb-50">
                            ...
                            <input type="file" name="image" id="image" class="form-control m-input">
                                <div class="mt-2">
                                    <img src="{{ $banner->image != '' ? asset('uploads/banner_image/' . $banner->image) :  '' }}" id="image-preview" width="200px" height="200px" />
                                </div>
                            @if ($errors->has('image'))
                                <span class="help-block" style="color:red">
