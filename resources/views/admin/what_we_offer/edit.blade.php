        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3>Update What We Offer</h3>
                </div>


                <!--begin::Form-->
                <form action="{{ route('admin_panel.what_we_offer.update', $whatWeOffer->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 {{ $errors->has('title') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="text" name="title" class="form-control m-input" required="required"
                                    value="{{ $whatWeOffer->title }}" placeholder="Name">
                            ...
                            <div class="col-lg-6 {{ $errors->has('description') ? ' has-error' : '' }} mb-50">
                                ...
                                <textarea rows="5" name="description" class="form-control" required="required" placeholder="Description">{{ $whatWeOffer->description }}</textarea>
                            ...
                            <div class="col-lg-6 {{ $errors->has('image') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="file" name="image" id="image" class="form-control m-input">
                                    <div class="mt-2">
                                        <img src="{{ $whatWeOffer->image != '' ? asset('uploads/what_we_offer_images/' . $whatWeOffer->image) :  '' }}" id="image-preview" width="200px" height="200px" />
                                    </div>
                                @if ($errors->has('image'))
                                    <span class="help-block" style="color:red">
