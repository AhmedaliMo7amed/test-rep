    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!--begin::Form-->
                <form action="{{ route('admin_panel.team.update', $team->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 {{ $errors->has('title') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="text" name="title" class="form-control m-input" required="required"
                                    value="{{ $team->title }}" placeholder="Name">
                            ...
                            <div class="col-lg-6 {{ $errors->has('job') ? ' has-error' : '' }} mb-50">
                                <label class="text-bold-600"> Job <span class="text-danger">*</span> </label>
    
                                <input type="text" name="job" id="job" class="form-control m-input" required="required"
                                    value="{{ $team->job }}" placeholder=" Job">
                            ...
                            <div class="col-lg-6 {{ $errors->has('image') ? ' has-error' : '' }} mb-50">
                                ...
                                <input type="file" name="image" id="image" class="form-control m-input">
                                    <div class="mt-2">
                                        <img src="{{ $team->image != '' ? asset('uploads/team_images/' . $team->image) :  '' }}" id="image-preview" width="200px" height="200px" />
                                    </div>
                                @if ($errors->has('image'))
                                    <span class="help-block" style="color:red">
