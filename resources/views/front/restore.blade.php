...
@section('title')
Dining, Restaurants, Bars & Nightlife | Serry Beach Resort
@endsection

@section('description')
Indulge in the best food & drinks in Hurghada at our restaurants and bars at Fanaa Food Hall, Dar Mezza Lounge, Nur Beach Club, Naz Night Club and much more.
@endsection

@section('keywords')
best restaurants in hurghada, hurghda restaurants, best bars in hurghada, seafood restaurant hurghada, serry restaurants, beach club hurghada, hurghada night clubs, night club hurghada, night clubs in hurghada, hurghada resorts
@endsection
                    ...
                    @foreach($category->sub_categories as $sub_category)
                        <div class="col-md-6 evenOddCard">
                            <div class="d-flex flex-column">
                                ...
                                <img src="{{ $sub_category->photo_path }}" alt="" class="evenOddCard_img img-card" />

                                @elseif ($sub_category->has_carousel == 1)


                                <div id="carouselExampleIndicators{{ $sub_category->id }}" class="evenOddCard_img img-card carousel slide" data-interval="false">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item active">
                                            <img class="d-block w-100 evenOddCard_img img-card" src="{{ asset('uploads/carousel/'.$sub_category->carousel_img_1) }}" alt="Serry Carousel">
                                        </div>
                                        @endisset
                                        @isset($sub_category->carousel_img_2)
                                        <div class="carousel-item">
                                            <img class="d-block w-100 evenOddCard_img img-card" src="{{ asset('uploads/carousel/'.$sub_category->carousel_img_2) }}" alt="Serry Carousel">
                                        </div>
                                        @endisset
                                        @isset($sub_category->carousel_img_3)
                                        <div class="carousel-item">
                                            <img class="d-block w-100 evenOddCard_img img-card" src="{{ asset('uploads/carousel/'.$sub_category->carousel_img_3) }}" alt="Serry Carousel">
                                        </div>
                                        @endisset
                                        @isset($sub_category->carousel_img_4)
                                        <div class="carousel-item">
                                            <img class="d-block w-100 evenOddCard_img img-card" src="{{ asset('uploads/carousel/'.$sub_category->carousel_img_4) }}" alt="Serry Carousel">
                                        </div>
                                        @endisset
                                        @isset($sub_category->carousel_img_5)
                                        <div class="carousel-item">
                                            <img class="d-block w-100 evenOddCard_img img-card" src="{{ asset('uploads/carousel/'.$sub_category->carousel_img_5) }}" alt="Serry Carousel">
                                        </div>
                                        @endisset
                                ...
                                <div class="classes.evenOddCard_content img-card-content">
