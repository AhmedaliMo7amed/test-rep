...
@section('title')
    Event Venues, Halls & Coworking Spaces | Serry Beach Resort
@endsection



@section('description')
    Run your business from our working spaces & meeting rooms, enjoy business services with highspeed WiFi hotspots, and
    host private events in banquet halls.
@endsection



@section('keywords')
    event coming soon, coworking space, work space near me, hurghada events, hurghada business lounge, banquet halls,
    business meeting, business events, manna menu
@endsection
...
@section('content')
    ...
    <main>
        ...
        <div class="anotherBanner">
            ...
            <img src="{{ asset('uploads/category_images/banners/' . $category->banner_image) }}" alt=""
            ...
            <div class="anotherBanner_content">
                ...
                <div class="container">
                    ...
                    <h1 class="arabFont  anotherBanner_content_title {{ $category->banner_color == 0 ? 'anotherBanner_content_title-b' : 'anotherBanner_content_title-w' }}"
                        style='{{ $category->banner_color == 0 ? 'color:#000' : 'color:#fff' }}'>
                        {{ $category->banner_header }}</h1>

                    <h1 class="anotherBanner_content_title"
                        style='{{ $category->banner_color == 0 ? 'color:#000' : 'color:#fff' }}'>
                        {{ $category->banner_title }}</h1>
                ...
                <div class="row">
                    ...
                    @if (isset($category))
                        @foreach ($category->sub_categories as $sub_category)
                            <div class="col-md-6 evenOddCard mb-4">
                                ...
                                <button type="button" class="mb-4 anotherFont mainCard_content_link"
                                data-toggle="modal" data-target="#BookNowModal"
                                data-popup="{{ $sub_category->popup_content }}">{{$sub_category->btn_text}}</button>
                                        @else
                                <button type="button" class="mb-4 anotherFont mainCard_content_link"
                                data-toggle="modal" data-target="#BookNowModal"
                                data-popup="{{ $sub_category->popup_content }}">More Info</button>
                                        @endif
                                @endif
                                        
                                        
                                        @if($sub_category->id == 11 || $sub_category->id == 12 )
        ...
        <div class="modal fade" id="BookNowModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
            aria-labelledby="BookNowModalLabel" aria-hidden="true">
